# NeoVim
## Install
- Windows: D:\Computer\Software\Neovim
- Linux: 
  - Ubuntu：
...
cd ~/.config/nvim/lua/plugin-config
vi ~/.config/nvim/init.vim
vi ~/.config/nvim/lua/plugins.lua
vi ~/.config/nvim/lua/keybindings.lua
vi ~/.local/share/nvim/site/pack/packer/start/packer.nvim
:PackerSync
- refer学习 Neovim 全配置， 逃离 VSCode.mhtml
